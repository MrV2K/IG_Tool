...
Procedure Get_Database()
  ...
  ReceiveHTTPFile("https://ftp2.grandis.nu/turran/FTP/~Uploads/mrv2k/IG_Tool/IG_Data.dat", Home_Path+Data_File)
  ReceiveHTTPFile("https://ftp2.grandis.nu/turran/FTP/~Uploads/mrv2k/IG_Tool/genres", Home_Path+"genres")
...
End
; IDE Options = PureBasic 6.12 beta 3 LTS (Windows - x64)
; CursorPosition = 591
; FirstLine = 497
; Folding = gbL-
; Optimizer
